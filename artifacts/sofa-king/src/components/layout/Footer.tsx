  ...
  export function Footer() {
    return (
      <footer className="bg-primary text-primary-foreground mt-24 py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/80">
              <li><a href="https://wa.me/5575991495793" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" data-testid="link-footer-whatsapp">WhatsApp: (75) 99149-5793</a></li>
              <li><a href="https://instagram.com/soffa_king" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2" data-testid="link-footer-instagram"><Instagram className="w-4 h-4" />@soffa_king</a></li>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-primary-foreground/20 text-center text-xs text-primary-foreground/50">
          © {new Date().getFullYear()} Sofá King — Todos os direitos reservados
        </div>
      </footer>
    );
  }
