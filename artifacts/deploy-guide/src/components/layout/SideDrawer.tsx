...
const menu: MenuItem[] = [
  {
    ...
    children: [
      ...
      { label: "Sofá Orgânico", href: "/?categoria=organicos#produtos" },
      { label: "Sofá Living", href: "/?categoria=living#produtos" },
      { label: "Sofá Fixo", href: "/?categoria=fixo#produtos" },
      { label: "Sofá Chaise", href: "/?categoria=chaise#produtos" },
      { label: "Sofá Ilha", href: "/?categoria=ilha#produtos" },
