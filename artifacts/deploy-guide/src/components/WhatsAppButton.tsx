...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center sm:items-start leading-tight flex-1 sm:flex-none">
        <span className="text-base">Falar com Vendedor</span>
        <span className="text-xs font-normal opacity-90">WhatsApp direto</span>
      </div>
      <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
